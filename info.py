...
BOT_TOKEN = environ.get('BOT_TOKEN', "8df269aa8db82133d3feca8e2bb0933d")
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002459554188').split()]
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002748763541'))  
BIN_CHANNEL = int(environ.get('BIN_CHANNEL', '-1002839994285'))  
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002813922984'))  
...
support_chat_id = environ.get('SUPPORT_CHAT_ID', '-1002749179475') 
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None

DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://yashdd:yashdd@cluster0.1kn6zcl.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
UPDATE_CHANNEL_LNK = environ.get('UPDATE_CHANNEL_LNK', 'https://t.me/+jbeRiFEV5NY4ZTk1')
...
SHORTENER_API = environ.get("SHORTENER_API", "cf65fef0003ff03c15d5c907f0647a479fc29060")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", "softurl.in")

SHORTENER_API2 = environ.get("SHORTENER_API2", "bc9e90eb5dfdd6a3a7a6e61cef1e2e3de23b922f")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", "shortxlinks.in")

SHORTENER_API3 = environ.get("SHORTENER_API3", "cf65fef0003ff03c15d5c907f0647a479fc29060")
...
INDEX_REQ_CHANNEL = int(environ.get('-1002824244103', -1002748763541))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002625346421')).split()]
